<template>
  <div class="bg-hh-black">
    <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div class="grid grid-cols-2 gap-8 xl:col-span-2">
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              ...
              <ul class="mt-4">
                <li>
                  <nuxt-link to="/virksomheder" class="text-base leading-6 text-gray-300 hover:text-white">
            ...
            <div class="mt-12 md:mt-0">
              ...
              <ul class="mt-4">
                <li>
                  <a href="https://happyhelper.dk/?utm_source=skod&utm_medium=site" target="_blank" class="text-base leading-6 text-gray-300 hover:text-white">
                    Happy Helper
                  </a>
                </li>
                <li class="mt-4">
                  <a href="https://www.instagram.com/made_by_my_butts/" target="_blank" class="text-base leading-6 text-gray-300 hover:text-white">
                    Skodbevægelsen
                  </a>
                </li>
                <li class="mt-4">
                  <a href="https://garage.coop/" target="_blank" class="text-base leading-6 text-gray-300 hover:text-white">
                    Coop
                  </a>
                </li>
              </ul>
      ...
      <div class="mt-8 border-t border-hh-white pt-8 md:flex md:items-center md:justify-between">
        <div class="flex md:order-2">
          <a href="https://www.facebook.com/happyhelperdk/" target="_blank" class="text-gray-400 hover:text-gray-300">
            <span class="sr-only">Facebook</span>
            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
            </svg>
          </a>
          <a href="https://www.instagram.com/happyhelper.dk/" target="_blank" class="ml-6 text-gray-400 hover:text-gray-300">
