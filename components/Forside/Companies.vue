    ...
    <div class="relative pt-16 px-4 sm:px-6 lg:pt-24 lg:px-8">
      <div class="relative max-w-7xl mx-auto">
        <div class="text-center">
          <h2 class="tracking-wide text-center font-sans text-4xl md:text-5xl leading-12 font-bold tracking-tight text-white sm:text-6xl sm:leading-14">
            Kom og hjælp
          </h2>
          <p class="mt-3 max-w-2xl mx-auto text-xl leading-7 text-white sm:mt-4">
        ...
        <div class="md:flex content-center justify-center flex-wrap p-4">
          <div v-for="(place, index) of placements" :key="index" class="md:flex md:w-1/2 lg:w-1/3 px-4 py-4">
            <div class="md:flex-1 rounded-lg overflow-hidden shadow-lg bg-white">
              <div class="flex-shrink-0">
                <img class="h-48 w-full object-cover" :src="place.img" alt="">
              </div>
