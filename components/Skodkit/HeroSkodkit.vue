      ...
      <div class="mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
        <div class="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
          ...
          <h2 class="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl lg:text-5xl xl:text-6xl">
            Kom igang med
            <br class="xl:hidden">
            <span class="text-hh-primary">det samme</span>
          </h2>
          <a href="#download" class="mt-3 max-w-md mx-auto text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl">
            Download al materiale
          </a>
          <div class="mt-10 sm:flex sm:justify-center lg:justify-start">
            <div class="rounded-md shadow">
              <a href="#download" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-hh-primary hover:bg-hh-primary focus:outline-none focus:border-hh-primary focus:shadow-outline-hh-primary transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10">
                Download materiale
              </a>
            </div>
          </div>
