    ...
    <div class="relative py-16 bg-white overflow-hidden">
      ...
      <div class="relative px-4 sm:px-6 lg:px-8">
        <div class="text-lg max-w-prose mx-auto mb-6">
          <p class="text-base text-center leading-6 text-hh-orange font-semibold tracking-wide uppercase">
            Din datasikkerhed først
          </p>
          <h1 class="mt-2 mb-8 text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">
            Privatlivspolitik hos Happy Helper A/S
          </h1>
        </div>
        <div class="prose prose-lg text-gray-500 mx-auto">
          ...
          <p>
            ...
            1610 København V
            <br>
            Telefon: <a href="tel:71998321">71998321</a>
            <br>
            Email: <a href="mailto:support@happyhelper.dk">support@happyhelper.dk</a>
          </p>
        </div>
      </div>
    </div>
